  ...
  methods: {
    fetchPosts: function fetchPosts() {
      ...
      axios.get('/api/posts', {
        ...
        _this.mainParams.last_page = last_page;
        _this.mainParams.total = total;
        _this.mainParams.current_page = current_page;
        _this.mainParams.posts = data;
      });
    }
  },
...
var render = function render() {
  ...
  return _c("li", {
    ...
    staticClass: "black"
  }, [_vm._v("Category : ")]), _vm._v(_vm._s(_vm.post.category.name))]), _vm._v(" "), _c("ul", {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      headerParams: _vm.headerParams
    }
  }), _vm._v(" "), _c("main-vue", {
    attrs: {
      mainParams: _vm.mainParams
    },
    on: {
      page: _vm.fetchPosts
    }
  }), _vm._v(" "), _c("footer-vue")], 1);
};
var staticRenderFns = [];
render._withStripped = true;
